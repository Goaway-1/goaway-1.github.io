...
## 탐욕법
  ...
  아래 나오는 2개의 __알고리즘 (크러스칼, 프림)은__ 모두 최소 신장트리 (MST : Minimum Spanning Tree) 구하기에 사용하는 대표적인 알고리즘이다. 이 신장 트리란 연결 그래프에서 사이클을 형성하는 간선을 제거하여 만든 트리이다. 아래 그림에서 1)는 사이클이 존재하는 그래프이고, 2)는 사이클이 존재하지 않는 신장트리이다.

  <img src="https://raw.githubusercontent.com/Goaway-1/goaway-1.github.io/master/_posts/images/MST.png" height="300" title="MST">
...
## 크러스칼 알고리즘
  ...
  <img src="https://raw.githubusercontent.com/Goaway-1/goaway-1.github.io/master/_posts/images/Krukal_1.png" height="300" title="Krukal_1">

  이때 위는 "번호", "아래는 집합 번호"라고 생각하며, 이는 트리형태를 1차원으로 표현한 것이다.

  ### 3. "[Union-Find](#Union-&-Find)"연산을 사용하여 사이클을 형성하지 않는다면 두 집합을 하나로 합친다. 이 연산은 아래에서 추가로 설명한다.
  ...
  <img src="https://raw.githubusercontent.com/Goaway-1/goaway-1.github.io/master/_posts/images/Krukal_2.png" height="300" title="Krukal_2">

  만약 아래와 같이 1,2,3,4가 하나의 집합일때, 1과 2를 __Find__ 연산한다면 두 연산은 모두 4가 반환되므로 집합 4에 포함되어 있다고 판단할 수 있다.
    
  <img src="https://raw.githubusercontent.com/Goaway-1/goaway-1.github.io/master/_posts/images/Krukal_3.png" height="300" title="Krukal_3">
